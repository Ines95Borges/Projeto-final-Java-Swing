 ...
 * @author Daniel
 */
public class NovaCompra2 extends javax.swing.JFrame {

    /**
     * Creates new form NovaCompra2
     */
    public NovaCompra2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovaCompra2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovaCompra2().setVisible(true);
            }
        });
    }
